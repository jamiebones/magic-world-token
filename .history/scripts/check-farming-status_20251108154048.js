...
async function main() {
    ...
    console.log("Total Staked Value:", stats.totalStakedValue ? hre.ethers.formatEther(stats.totalStakedValue) : "0", "USD");
    console.log("Total Rewards Deposited:", stats.totalRewardsDeposited ? hre.ethers.formatEther(stats.totalRewardsDeposited) : "0", "MWG");
    console.log("Total Rewards Distributed:", stats.totalRewardsDistributed ? hre.ethers.formatEther(stats.totalRewardsDistributed) : "0", "MWG");
    console.log("Available Rewards:", stats.availableRewards ? hre.ethers.formatEther(stats.availableRewards) : "0", "MWG");
    console.log();
